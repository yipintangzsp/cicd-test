...
function buildPortal(evidence, ledger, risks, playbooks, scores) {
  ...
  return `<!doctype html>
<html lang="zh-CN" data-visual-rev="v14-intelligence-hypergrid-20260601" data-sonic-rev="v14-sonic-command-20260601">
<head>
...
<style>
:root{color-scheme:dark;--void:#04030a;--ink:#f8fbff;--muted:#9caec4;--line:rgba(185,234,255,.2);--cyan:#00f0ff;--mag:#ff3df2;--gold:#ffe66d;--green:#39ff88;--orange:#ff6b3d;--blue:#7dd3fc}*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;min-height:100vh;color:var(--ink);font-family:"DIN Condensed","Avenir Next Condensed","Bahnschrift","Segoe UI",sans-serif;background:#04030a;overflow-x:hidden;cursor:crosshair}body:before{content:"";position:fixed;inset:0;z-index:-4;background:radial-gradient(circle at 12% 4%,rgba(0,240,255,.34),transparent 28%),radial-gradient(circle at 88% 10%,rgba(255,61,242,.24),transparent 30%),radial-gradient(circle at 60% 100%,rgba(57,255,136,.13),transparent 35%),linear-gradient(135deg,#06030d 0,#07172a 42%,#16091d 72%,#03050a 100%)}body:after{content:"";position:fixed;inset:0;z-index:-2;pointer-events:none;background:linear-gradient(rgba(255,255,255,.045) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px),repeating-linear-gradient(0deg,rgba(255,255,255,.035) 0 1px,transparent 1px 4px);background-size:34px 34px,34px 34px,100% 5px;mask-image:linear-gradient(to bottom,#000,rgba(0,0,0,.5),transparent 96%)}button{font:inherit}.sonic{position:relative;overflow:hidden}.sonic:focus-visible{outline:2px solid var(--gold);outline-offset:3px}.ripple{position:absolute;border-radius:50%;transform:translate(-50%,-50%);width:12px;height:12px;background:radial-gradient(circle,rgba(255,255,255,.9),rgba(0,240,255,.15),transparent 72%);pointer-events:none;animation:ripple .55s ease-out forwards}.shell{max-width:1920px;margin:0 auto;padding:18px}.hud{display:grid;grid-template-columns:minmax(0,1.1fr) minmax(420px,.9fr);gap:16px;min-height:690px}.hero,.orbital,.panel{border:1px solid var(--line);border-radius:8px;background:linear-gradient(145deg,rgba(6,14,28,.86),rgba(11,7,24,.68));box-shadow:0 18px 70px rgba(0,0,0,.42),inset 0 0 40px rgba(0,240,255,.05);backdrop-filter:blur(18px);position:relative;overflow:hidden}.hero{padding:24px;display:grid;grid-template-rows:auto 1fr auto;isolation:isolate}.hero:before,.panel:before{content:"";position:absolute;inset:-40%;background:conic-gradient(from 120deg,transparent,rgba(0,240,255,.16),transparent,rgba(255,61,242,.12),transparent);animation:turn 18s linear infinite;z-index:-1}.kicker{display:flex;gap:9px;flex-wrap:wrap}.chip{display:inline-flex;align-items:center;gap:7px;border:1px solid rgba(255,255,255,.17);border-radius:999px;padding:8px 11px;background:rgba(4,8,18,.62);color:#dffbff;font-weight:900;font-size:12px;text-transform:uppercase}.chip:before{content:"";width:7px;height:7px;border-radius:50%;background:var(--accent,var(--cyan));box-shadow:0 0 16px var(--accent,var(--cyan))}.title{align-self:center}.title h1{margin:20px 0 14px;font-size:clamp(54px,8.5vw,150px);line-height:.78;letter-spacing:0;text-transform:uppercase;text-shadow:0 0 28px rgba(0,240,255,.25),0 0 60px rgba(255,61,242,.18)}.title h1 span{display:block;color:transparent;-webkit-text-stroke:1px rgba(255,255,255,.78);text-shadow:none}.lead{max-width:960px;color:#c8d7e8;font-size:17px;line-height:1.65}.nav{display:flex;gap:10px;flex-wrap:wrap;margin-top:18px}.btn{min-height:42px;border:1px solid rgba(255,255,255,.16);border-radius:8px;background:linear-gradient(135deg,rgba(0,240,255,.14),rgba(255,61,242,.1));color:#f7fbff;padding:10px 13px;cursor:pointer;font-weight:950;letter-spacing:.02em;text-transform:uppercase;transition:.18s ease}.btn:hover,.btn.active{transform:translateY(-2px);border-color:var(--accent,var(--cyan));box-shadow:0 0 28px rgba(0,240,255,.18)}.btn.sound-on{--accent:var(--green)}.btn.sound-off{--accent:var(--orange)}.status-strip{display:grid;grid-template-columns:repeat(6,1fr);gap:10px;margin-top:18px}.metric{border:1px solid rgba(255,255,255,.14);border-radius:8px;background:linear-gradient(180deg,rgba(255,255,255,.08),rgba(255,255,255,.02));min-height:118px;text-align:left;color:var(--ink);padding:14px;cursor:pointer}.metric b{display:block;font-size:42px;line-height:1;color:var(--accent);text-shadow:0 0 18px var(--accent)}.metric small,.metric span{display:block;color:var(--muted);font-weight:900}.metric span{margin-top:9px;color:#fff}.orbital{min-height:690px;display:grid;place-items:center}.orbital:before{content:"";position:absolute;width:640px;height:640px;border-radius:50%;border:1px dashed rgba(255,255,255,.16);box-shadow:0 0 90px rgba(0,240,255,.13),inset 0 0 90px rgba(255,61,242,.08);animation:turn 35s linear infinite}.orbital:after{content:"";position:absolute;width:420px;height:420px;border-radius:50%;border:1px solid rgba(0,240,255,.24);animation:turn 24s linear reverse infinite}.core{width:248px;height:248px;border-radius:50%;display:grid;place-items:center;text-align:center;background:radial-gradient(circle,rgba(0,240,255,.32),rgba(255,61,242,.13) 45%,rgba(3,7,18,.2) 70%,transparent);border:1px solid rgba(0,240,255,.45);box-shadow:0 0 80px rgba(0,240,255,.28),0 0 150px rgba(255,61,242,.16);z-index:2}.core b{font-size:74px;line-height:.85}.core span{color:#ccefff;font-weight:950}.orbit-node{position:absolute;left:50%;top:50%;width:168px;min-height:78px;margin:-39px -84px;transform:rotate(var(--a)) translateX(238px) rotate(calc(-1 * var(--a)));border:1px solid color-mix(in srgb,var(--accent) 56%,white 0%);border-radius:8px;background:rgba(3,8,18,.78);color:#f7fbff;text-align:left;padding:11px;cursor:pointer;box-shadow:0 0 28px color-mix(in srgb,var(--accent) 25%,transparent);animation:pulse 2.8s ease-in-out infinite alternate}.orbit-node strong{display:block;font-size:12px;color:#d9f8ff}.orbit-node span{font-size:28px;color:var(--accent);font-weight:950}.views{margin-top:16px}.view{display:none;grid-template-columns:repeat(12,1fr);gap:14px}.view.active{display:grid}.panel{padding:16px;min-height:300px}.wide{grid-column:span 12}.half{grid-column:span 6}.third{grid-column:span 4}.panel h2{margin:0 0 12px;font-size:30px;text-transform:uppercase}.risk-list,.playbooks,.matrix{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:10px}.risk-card,.playbook,.matrix button,.stage-row{border:1px solid rgba(255,255,255,.14);border-radius:8px;background:linear-gradient(145deg,rgba(9,20,38,.88),rgba(26,9,34,.62));color:#f7fbff;text-align:left;cursor:pointer;transition:.18s ease}.risk-card{min-height:132px;padding:13px;display:grid;grid-template-columns:42px 1fr;gap:8px}.risk-card:hover,.playbook:hover,.matrix button:hover,.stage-row:hover{transform:translateY(-3px) scale(1.01);border-color:var(--accent);box-shadow:0 0 35px color-mix(in srgb,var(--accent) 22%,transparent)}.risk-rank{grid-row:span 3;color:var(--accent);font-weight:950}.risk-card b{font-size:42px;color:var(--accent);line-height:.9}.risk-card strong{font-size:13px;text-transform:uppercase}.risk-card small{grid-column:2;color:var(--muted);font-size:12px}.playbook{padding:14px}.playbook span{color:var(--accent);font-weight:950}.playbook h3{margin:8px 0;font-size:16px}.playbook p{color:#d5e7f5;font-size:13px;line-height:1.5}.playbook small{color:var(--muted)}.stage-row{display:grid;grid-template-columns:180px 1fr 92px;gap:10px;align-items:center;margin:8px 0;padding:10px}.stage-row b{height:12px;width:var(--score);border-radius:999px;background:linear-gradient(90deg,var(--orange),var(--gold),var(--green));box-shadow:0 0 18px var(--accent)}.stage-row em{font-style:normal;color:var(--muted);font-weight:900}.matrix button{min-height:92px;padding:15px;font-weight:950}.detail{white-space:pre-wrap;color:#d6e6f4;background:rgba(0,0,0,.28);border:1px solid var(--line);padding:14px;border-radius:8px;max-height:430px;overflow:auto;font-family:"SFMono-Regular","Cascadia Mono",monospace;font-size:12px}.sound-meter{height:9px;border-radius:999px;background:linear-gradient(90deg,var(--cyan),var(--mag),var(--gold),var(--green));box-shadow:0 0 24px rgba(0,240,255,.36);transform-origin:left;animation:meter 1.2s ease-in-out infinite alternate}.sonic-toast{position:fixed;right:18px;bottom:18px;z-index:20;border:1px solid rgba(255,255,255,.2);border-radius:8px;background:rgba(4,8,18,.82);backdrop-filter:blur(14px);padding:10px 12px;color:#eaffff;font-weight:950;opacity:0;transform:translateY(12px);transition:.18s ease}.sonic-toast.show{opacity:1;transform:none}@keyframes turn{to{transform:rotate(360deg)}}@keyframes pulse{from{filter:saturate(1);opacity:.86}to{filter:saturate(1.35);opacity:1}}@keyframes ripple{to{width:260px;height:260px;opacity:0}}@keyframes meter{from{transform:scaleX(.2)}to{transform:scaleX(1)}}@media(max-width:1180px){.hud{grid-template-columns:1fr}.status-strip{grid-template-columns:repeat(2,1fr)}.half,.third{grid-column:span 12}.orbital{min-height:560px}.orbit-node{transform:none;position:relative;left:auto;top:auto;margin:6px;display:inline-block}.orbital{display:flex;align-items:center;justify-content:center;flex-wrap:wrap}.orbital:before,.orbital:after{display:none}}@media(max-width:720px){.shell{padding:10px}.title h1{font-size:52px}.status-strip{grid-template-columns:1fr}.stage-row{grid-template-columns:1fr}.view{grid-template-columns:1fr}.wide,.half,.third{grid-column:auto}}
...
function lintAll() {
  ...
  for (const needle of ['v14-intelligence-hypergrid-20260601', 'v14-sonic-command-20260601', 'V14 Sonic Cockpit', 'Command Deck', 'Risk Radar', 'Recovery Room', 'Command Matrix', 'AudioContext', 'Sound ON', 'pointerdown']) if (!html.includes(needle)) throw new Error(`portal missing ${needle}`);
